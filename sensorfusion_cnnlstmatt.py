...
with h5py.File('train_val_data_jinyang3set_seq6_withlabel_new.mat', 'r') as f:
...
with h5py.File('us_train_val_data_jinyangfiltered.mat', 'r') as f:
...
# ---------- 3. US 分支：MultiheadAttention + LeakyReLU ----------
...
# ---------- 4. EMG 分支：MultiheadAttention + LeakyReLU ----------
...
def train_single_run(run_index):
    ...
    # --- 已更改 --- 动态的文件名
    model_filename = f'models/sensorfusion_cnnlstmatt_jinyang{run_index}.pth'
    ...
    figure_filename = f'figures/sensorfusion_mha_leakyrelu_loss_run{run_index}.png'
