...
class SensorFusion(nn.Module):
    ...
    def forward(self, us, emg, act):
        ...
        return self.fc_reg(aggregated_feat)
...
def train_single_run(run_index):
    ...
    # --- 已更改 --- 动态的模型文件名
    model_filename = f'models/sensorfusion_cnn_subject7{run_index}.pth'
    ...
    # --- 已更改 --- 动态的图片文件名
    figure_filename = f'figures/sensorfusion_cnn_regr_only_loss_run{run_index}.png'
